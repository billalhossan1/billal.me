...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:bh302333@gmail.com?subject=${encodeURIComponent(
      subject
    )}&body=${body}`;
          ...
          <AnimatedSection animation="slide-in-left" delay={0.2}>
            <div className="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-xl shadow-lg dark:shadow-xl hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 relative overflow-hidden group">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-sky-500 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-pulse-slow"
                >
                  Send Message
                </button>
              </form>
